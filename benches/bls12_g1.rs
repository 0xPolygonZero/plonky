...
use plonky::{Bls12377Base, Bls12377Scalar, Field, G1_GENERATOR_AFFINE, ProjectivePoint};
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    let p1_projective = ProjectivePoint { x: p1_affine.x * 2, y: p1_affine.y * 2, z: Bls12377Base::TWO };
