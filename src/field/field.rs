    ...
    + DeserializeOwned
{
    ...
    fn cyclic_subgroup_unknown_order(generator: Self) -> Vec<Self> {
        ...
        // According to the Group theory to get a subgroup
        // that is generated by particularly generator element
        // you can start from ONE element and add new elements
        // until you meet ONE element again.
        // It isn’t required to store an additional set of elements to
        // determine whether it’s all elements of the subgroup.
